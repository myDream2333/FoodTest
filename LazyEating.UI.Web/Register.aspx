                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td colspan="2" class="td23">
                            <input id="txtRealName" name="txtRealName" type="text" required />
                    ...
                    <tr>
                        ...
                        <td colspan="2" class="td23">
                            <input id="txtPhone" name="txtPhone" type="text" required />
                    ...
                    <tr>
                        ...
                        <td colspan="2" class="td23">
                            <textarea id="txtAddress" name="txtAddress" rows="3" cols="22" required ></textarea>
                    ...
                    <tr>
                        <td class="td1">密码：</td>
                        <td colspan="2" class="td23">
                            <input id="txtPassword" name="txtPassword" type="password" pattern="^[a-zA-Z]\w{5,7}$" maxlength="16" required />
                    ...
                    <tr>
                        ...
                        <td colspan="2" class="td23">
                            <input id="txtPassword2" name="txtPassword2" type="Password" onKeyUp="setErrorInfo()" required />
